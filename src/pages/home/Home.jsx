...
const Home = () => {
  return (
    <div className='bg-black h-full pt-5'>
      <Nav />
      <div className='container mx-auto px-5 mt-14 lg:pt-0 min-h-screen'>
      ...
      <div className='min-h-screen'>
        <div className='text-white text-center'>
          <h1 className='text-3xl pb-4 md:text-5xl'>You’re in good company</h1>
          <h2>Let’s See Together What Our Clients Think About Our Company</h2>
        </div>
        <div className='grid grid-cols-2  gap-y-10 pt-16 md:grid-cols-4'>

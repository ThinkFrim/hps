...
const Home = () => {
  return (
    <div className='bg-black h-full'>
      <Nav />
      <div className='container mx-auto px-5 mt-5 lg:mt-2 min-h-screen'>
      ...
      <div className='container mx-auto px-5 mt-24 min-h-screen'>
      ...
      <div className='my-16'>
        <div
          className='flex flex-col md:flex-row items-center md:gap-10 lg:pb-[12rem] md:px-10'
          id='aboutus'>
        ...
        <div className='flex flex-col justify-center items-center md:flex-row-reverse md:gap-10 md:px-10'>
      ...
      <div className='py-16'>
        ...
        <div className='grid grid-cols-2  gap-5 md:gap-10 px-2 pt-16 md:grid-cols-4'>
